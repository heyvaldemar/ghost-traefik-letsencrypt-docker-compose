...
- **`ghost:6.64.0` moved to `ghost:6.65.0`.** The freshness check reported the lag; the deploy job booted the stack on the new image before this landed.
...
- **`mysql:8.4-oracle` was rebuilt upstream**; the pin moved from `sha256:85b9bf2e29cf…` to `sha256:0744ee5ef89c…`. Same version, same tag, a rebuilt base image — the usual shape of a security fix in a base layer.
...
- **`ghost:6.64.0` was rebuilt upstream**; the pin moved from `sha256:a31d03f1f629…` to `sha256:586821cfebac…`. Same version, same tag, a rebuilt base image — the usual shape of a security fix in a base layer.

## [1.8.5] - 2026-09-16

### Changed

- **`ghost:6.63.0` moved to `ghost:6.64.0`.** The freshness check reported the lag; the deploy job booted the stack on the new image before this landed.
...
- **`ghost:6.63.0` was rebuilt upstream**; the pin moved from `sha256:69dec998a173…` to `sha256:e05bc1169fb2…`. Same version, same tag, a rebuilt base image — the usual shape of a security fix in a base layer.
...
- **A shutdown grace period for MySQL.** Docker stops a container with
...
[Unreleased]: https://github.com/heyvaldemar/ghost-traefik-letsencrypt-docker-compose/compare/v1.8.8...HEAD
...
[1.7.0]: https://github.com/heyvaldemar/ghost-traefik-letsencrypt-docker-compose/compare/v1.6.0...v1.7.0
[1.6.0]: https://github.com/heyvaldemar/ghost-traefik-letsencrypt-docker-compose/compare/v1.5.0...v1.6.0
[1.5.0]: https://github.com/heyvaldemar/ghost-traefik-letsencrypt-docker-compose/compare/v1.4.0...v1.5.0
[1.4.0]: https://github.com/heyvaldemar/ghost-traefik-letsencrypt-docker-compose/compare/v1.3.0...v1.4.0
[1.3.0]: https://github.com/heyvaldemar/ghost-traefik-letsencrypt-docker-compose/compare/v1.2.1...v1.3.0
[1.2.1]: https://github.com/heyvaldemar/ghost-traefik-letsencrypt-docker-compose/compare/v1.2.0...v1.2.1
[1.2.0]: https://github.com/heyvaldemar/ghost-traefik-letsencrypt-docker-compose/compare/v1.1.0...v1.2.0
[1.1.0]: https://github.com/heyvaldemar/ghost-traefik-letsencrypt-docker-compose/compare/v1.0.0...v1.1.0
